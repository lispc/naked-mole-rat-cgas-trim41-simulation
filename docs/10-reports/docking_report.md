...
> **本文档专注于对接实验的完整记录。** 项目日常进度、MD 生产运行、分析结果等请查阅 [`docs/00-project/project_log.md`](../00-project/project_log.md)。
>
> 本文档包含早期（2026-04-22 ~ 2026-04-23）的项目决策记录（§§1-9），因为彼时项目日志尚未拆分。§10 起为对接实验正文。
>
> 最后更新：2026-04-23
