...
**位置**：`sequences/Hsap_cGAS_4mut.fasta`、`scripts/calc_residue_distances.py`、`docs/10-reports/af3_mutation_analysis.md`
...
- `docs/10-reports/af3_mutation_analysis.md` 中的大量数据（如 Hgal_rev 的 RMSD = 13.043Å）是基于**错误的反向突变**（S463C 而非正确的 S463D）
...
**位置**：`docs/10-reports/docking_report.md` 第274行 vs. 其他所有文档
