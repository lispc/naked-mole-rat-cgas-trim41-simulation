...
| 任务 | 进度 | ETA |
|------|------|-----|
| S305-phos rep1 (CUDA:0) | ~15.5ns / 200ns | ~12h |
| S305-phos rep2 (CUDA:1) | ~15.6ns / 200ns | ~12h |
| S305-phos rep3 (CUDA:2) | ~15.5ns / 200ns | ~12h |
| GROMACS 2026 验证 (CUDA:3) | ~9.8ns / 200ns | ~32h |
...
| 最小化 | OpenMM EM | ✅ 10 分钟 |
| 生产 | 200ns × 3 reps (S305-phos) | 🔄 ~12h/GPU |
| 生产 | 200ns × 3 reps (S305E) | 待启动 |
