...
TRIM56 has experimentally established K347 (murine K335) as the monoubiquitination site that promotes cGAS dimerization on DNA [10]. However, **no study has mapped the TRIM41 ubiquitination site on cGAS** [11]. In our apo-state quaternary model, **K315 is the only lysine geometrically accessible** to the TRIM41 RING-E2~Ub catalytic center, while K347 remains >50 Å away. To test whether DNA-bound dimerization exposes K347 via a trans-ubiquitination mechanism, we modeled the cGAS-DNA dimer + TRIM41 SPRY complex with Boltz-2 (5 models). In all models, SPRY bridges the C-terminal faces of both cGAS protomers. K315 is >50 Å from SPRY and completely inaccessible. K347 moves closer (~15 Å minimum distance to SPRY), but remains outside the catalytic range (<8–10 Å) required for ubiquitin transfer. The two K347 residues sit ~18 Å apart at the dimer interface—close enough for trans-recognition, yet the catalytic geometry remains unfavorable. Thus, **K347 is the nearest lysine in the DNA-bound dimer, but trans-ubiquitination is not structurally supported by the Boltz-2 models**.
...
- In the **DNA-bound monomeric state**, SPRY shifts to the C-terminal face; K315 is inaccessible and K347 remains >40 Å from SPRY.
- In the **DNA-bound dimeric state**, SPRY bridges both cGAS protomers at the C-terminal face; K347 is the nearest lysine (~15 Å) but still outside catalytic range, and K315 remains >50 Å away.
